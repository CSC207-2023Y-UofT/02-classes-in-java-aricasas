...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object
     * This constructor takes in two String objects as arguments and sets their concatenation
     * as the instance's name.
     *
     * @param first_name the first part of the name for this Silly instance.
     * @param last_name the last part of the name for this Silly instance.
     */
